(function (root) {
    ...
    const aboutMessages = {
        ...
        ar: {
            'about.title': 'حول', 'about.version': 'الإصدار', 'about.commitDate': 'تاريخ الالتزام', 'about.summary': 'غيّر عددًا واحدًا إلى 1 لموازنة معادلة.',
        ...
        ru: {
            'about.title': 'О игре', 'about.version': 'Версия', 'about.commitDate': 'Дата коммита', 'about.summary': 'Замените одно число на 1, чтобы уравновесить уравнение.',
    ...
    const modeMessages = {
        ...
        ar: { 'mode.tutorial': 'البرنامج التعليمي', 'mode.easy': 'سهل', 'mode.normal': 'عادي', 'mode.hard': 'صعب', 'mode.expert': 'خبير', 'mode.extreme': 'شديد الصعوبة', 'mode.custom': 'مخصص', 'mode.daily': 'يومي', 'mode.timed': 'ضد الساعة', 'mode.endless': 'لا نهائي', 'mode.challenges': 'تحديات' },
        bn: { 'mode.tutorial': 'টিউটোরিয়াল', 'mode.easy': 'সহজ', 'mode.normal': 'সাধারণ', 'mode.hard': 'কঠিন', 'mode.expert': 'বিশেষজ্ঞ', 'mode.extreme': 'চরম', 'mode.custom': 'কাস্টম', 'mode.daily': 'দৈনিক', 'mode.timed': 'সময়বদ্ধ', 'mode.endless': 'অন্তহীন', 'mode.challenges': 'চ্যালেঞ্জ' },
        ...
        ru: { 'mode.tutorial': 'Обучение', 'mode.easy': 'Легко', 'mode.normal': 'Обычный', 'mode.hard': 'Сложно', 'mode.expert': 'Эксперт', 'mode.extreme': 'Экстрим', 'mode.custom': 'Своя игра', 'mode.daily': 'Ежедневно', 'mode.timed': 'На время', 'mode.endless': 'Бесконечно', 'mode.challenges': 'Испытания' },
        ...
        tr: { 'mode.tutorial': 'Eğitim', 'mode.easy': 'Kolay', 'mode.normal': 'Normal', 'mode.hard': 'Zor', 'mode.expert': 'Uzman', 'mode.extreme': 'Aşırı zor', 'mode.custom': 'Özel', 'mode.daily': 'Günlük', 'mode.timed': 'Süreli', 'mode.endless': 'Sonsuz', 'mode.challenges': 'Meydan okumalar' },
        ur: { 'mode.tutorial': 'سبق', 'mode.easy': 'آسان', 'mode.normal': 'عام', 'mode.hard': 'مشکل', 'mode.expert': 'ماہر', 'mode.extreme': 'انتہائی مشکل', 'mode.custom': 'اپنی', 'mode.daily': 'روزانہ', 'mode.timed': 'وقت کی دوڑ', 'mode.endless': 'لامتناہی', 'mode.challenges': 'چیلنجز' }
    };
    ...
    const openingMessages = {
        ...
        ar: { 'message.howToPlay': 'طريقة اللعب', 'message.tutorial': 'غيّر عددًا واحدًا إلى 1.', 'message.daily': 'مسألة اليوم', 'message.dailyBody': 'مسألة مشتركة واحدة اليوم.', 'message.timed': 'ضد الساعة', 'message.timedBody': 'حل أكبر عدد ممكن خلال 60 ثانية.', 'message.endless': 'لا نهائي', 'message.endlessBody': 'ترتفع الصعوبة. لديك ثلاث فرص.', 'message.curated': 'مسألة مصنوعة يدويًا {round} من {count}.', 'message.standardBody': 'غيّر عددًا واحدًا ثم تحقق.', 'message.challengeBody': 'جولة أصعب. خذ وقتك.' },
        bn: { 'message.howToPlay': 'কীভাবে খেলবেন', 'message.tutorial': 'একটি সংখ্যা 1 করুন।', 'message.daily': 'দৈনিক ধাঁধা', 'message.dailyBody': 'আজ সবার জন্য একই ধাঁধা।', 'message.timed': 'সময়বদ্ধ', 'message.timedBody': '60 সেকেন্ডে যত পারেন সমাধান করুন।', 'message.endless': 'অন্তহীন', 'message.endlessBody': 'কঠিনতা বাড়ে। আপনার তিনটি সুযোগ আছে।', 'message.curated': 'হাতে তৈরি ধাঁধা {round}/{count}।', 'message.standardBody': 'একটি সংখ্যা বদলে পরীক্ষা করুন।', 'message.challengeBody': 'কঠিন রাউন্ড। সময় নিন।' },
        ...
        ru: { 'message.howToPlay': 'Как играть', 'message.tutorial': 'Измените одно число на 1.', 'message.daily': 'Задача дня', 'message.dailyBody': 'Одна общая задача на сегодня.', 'message.timed': 'На время', 'message.timedBody': 'Решите как можно больше за 60 секунд.', 'message.endless': 'Бесконечно', 'message.endlessBody': 'Сложность растёт. У вас три шанса.', 'message.curated': 'Авторская задача {round}/{count}.', 'message.standardBody': 'Измените одно число и проверьте.', 'message.challengeBody': 'Более сложный раунд. Не спешите.' },
        vi: { 'message.howToPlay': 'Cách chơi', 'message.tutorial': 'Đổi một số thành 1.', 'message.daily': 'Câu đố hằng ngày', 'message.dailyBody': 'Một câu đố chung cho hôm nay.', 'message.timed': 'Tính giờ', 'message.timedBody': 'Giải được bao nhiêu trong 60 giây.', 'message.endless': 'Vô tận', 'message.endlessBody': 'Độ khó tăng dần. Bạn có ba cơ hội.', 'message.curated': 'Câu đố do tác giả thiết kế {round}/{count}.', 'message.standardBody': 'Đổi một số, rồi kiểm tra.', 'message.challengeBody': 'Một vòng khó hơn. Cứ từ tốn.' },
        ...
        ur: { 'message.howToPlay': 'کیسے کھیلیں', 'message.tutorial': 'ایک عدد کو 1 میں بدلیں۔', 'message.daily': 'روزانہ پہیلی', 'message.dailyBody': 'آج کے لیے ایک مشترک پہیلی۔', 'message.timed': 'وقت کی دوڑ', 'message.timedBody': '60 سیکنڈ میں جتنی ہو سکے حل کریں۔', 'message.endless': 'لامتناہی', 'message.endlessBody': 'مشکل بڑھتی ہے۔ آپ کے پاس تین موقعے ہیں۔', 'message.curated': 'ہاتھ سے بنائی گئی پہیلی {round}/{count}۔', 'message.standardBody': 'ایک عدد بدلیں، پھر جانچیں۔', 'message.challengeBody': 'زیادہ مشکل راؤنڈ۔ اطمینان سے کریں۔' }
    };
    ...
    const customValidationMessages = {
        ...
        ar: { 'custom.chooseOperation': 'اختر عملية', 'custom.chooseOperationBody': 'اختر عملية واحدة على الأقل.', 'custom.chooseIdentity': 'اختر + أو − أو × أو ÷ أو ^', 'custom.chooseIdentityBody': 'أضف عملية يمكنها تغيير عدد إلى 1.', 'custom.checkTargets': 'تحقق من الأهداف', 'custom.checkTargetsBody': 'لا يمكن أن يتجاوز الأدنى الأقصى.' },
    ...
    const finalMessages = {
        ...
        ar: {
            ...
            'tutorial.restore': 'جرّب العدد المحدد', 'tutorial.restoreBody': 'انقر العدد المحدد مرة أخرى لاستعادته.',
            'tutorial.complete': 'اكتمل البرنامج التعليمي', 'tutorial.completeBody': 'أصبحت أول جولة سهلة جاهزة.',
            'tutorial.retry': 'ليس تمامًا', 'tutorial.retryBody': 'جرّب تغيير العدد 3 المحدد ثم تحقق مرة أخرى.',
            'hint.side': 'تلميح: اختر طرفًا', 'hint.sideBody': 'الطرف المحدد يحتوي على التغيير المقصود.',
            'hint.number': 'تلميح: العدد', 'hint.numberBody': 'العدد المحدد هو المستخدم في الحل المولد.',
        ...
        ru: {
            ...
            'challenges.complete': 'Набор испытаний пройден', 'challenges.completeBody': 'Вы решили все авторские задачи: {count}.',
            ...
            'shared.challenge': 'Общая авторская задача', 'shared.custom': 'Общая пользовательская задача',
            ...
            'share.challenge': 'авторское испытание {round}', 'share.puzzle': 'задача «{mode}»'
        },
        vi: {
            ...
            'modeDescription.challenges': 'Mười câu đố do tác giả thiết kế với nhiều phép toán.',
            ...
            'challenges.complete': 'Hoàn thành bộ thử thách', 'challenges.completeBody': 'Bạn đã giải cả {count} câu đố do tác giả thiết kế.',
            ...
            'shared.challenge': 'Câu đố do tác giả thiết kế được chia sẻ', 'shared.custom': 'Câu đố tùy chỉnh được chia sẻ',
            ...
            'share.challenge': 'thử thách do tác giả thiết kế {round}', 'share.puzzle': 'câu đố {mode}'
        },
        tr: {
        ...
        ur: {
            ...
            'modeDescription.challenges': 'مختلف عمل والی دس ہاتھ سے بنائی گئی پہیلیاں۔',
            ...
            'challenges.complete': 'چیلنج سیٹ مکمل', 'challenges.completeBody': 'آپ نے تمام {count} ہاتھ سے بنائی گئی پہیلیاں حل کر لیں۔',
            ...
            'shared.challenge': 'مشترک ہاتھ سے بنائی گئی پہیلی', 'shared.custom': 'مشترک اپنی پہیلی',
    ...
    const improvementMessages = {
        ...
        ru: {
            ...
            'result.alternate': 'Другой способ', 'result.alternateBody': 'Эта замена тоже уравновешивает уравнение.',
