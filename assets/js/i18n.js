(function (root) {
    ...
    "action.finished": "Session finished",
    "action.replayIncorrect": "Replay incorrect",
    ...
    "options.gamepad": "Standard-layout gamepad (current puzzle): D-pad or left stick selects · bottom face button changes or restores · top face button hints · Start/Menu checks or continues.",
    ...
    "about.privacyBody": "This project does not send data to or collect data for its developer. Game progress, settings, and statistics are stored only in your browser.",
    "about.hostingPrivacy": "When your browser requests the game's files, the web hosting provider may collect request information such as your IP address, browser details, and timestamps under its own privacy policy.",
